...
urlpatterns = patterns('',
    ...
    url(r'^registeroperation/',
        TemplateView.as_view(template_name='register_operation.html'), name='register_operation'),
    ...
    url(r'^api/%s/processes/?$' % VERSION, 'streambossweb.web.api.processes'),
    url(r'^api/%s/processes/(%s+)$' % (VERSION, ACCEPTED_RESOURCE_PATTERN), 'streambossweb.web.api.process_resource'),
